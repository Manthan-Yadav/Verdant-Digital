    ...
    <section class="py-5 text-center" style="padding-top: 10rem !important;">
        <div class="container px-4">
            ...
            <p class="lead  mx-auto" style="max-width: 600px;">
                We bring together industry pioneers with proven track records luxury visual branding, and top-tier software organizations.
            </p>
        </div>
    </section>
        ...
        <div class="container px-4 text-start">
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="p-5 rounded-4 d-flex flex-column flex-md-row gap-4 h-100"
                        style="background-color:#050b0a;
                        ...
                        <div>
                            ...
                            <span class="subheading d-block mb-1"
                                style="font-size:.55rem;color:var(--secondary-color);">
